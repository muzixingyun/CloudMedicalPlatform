        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="all-admin-index.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
                    ...
                    <span class="logo-lg"><b>医院数据</b>后台管理</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <form action="${pageContext.request.contextPath}/doctor/findByCondition">
                <section class="sidebar">
                    ...
                    <li class="header">筛选</li>
                    <font style="color: whitesmoke">省&nbsp&nbsp&nbsp&nbsp&nbsp</font>
                    ...
                    <br/>
                    <br/>
                    <font style="color: whitesmoke">市&nbsp&nbsp&nbsp&nbsp&nbsp</font>
                    ...
                    <br/>
                    <br/>
                    <font style="color: whitesmoke">县/区</font>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="${pageContext.request.contextPath}/index.jsp"><i class="fa fa-dashboard"></i>
                            首页</a></li>
                    </ol>
                </section>
                <!-- 内容头部 /-->
                <table border="soild">
                    <c:forEach var="doctor" items="${doctorList}">
                            <td>
                                ...
                                ${doctor.doctorName}
                                <br>
                                ${doctor.province}/${doctor.city}/${doctor.county}
                                <br>
                                ${doctor.hospital}
                                <br>
                                擅长：${doctor.excel}
                                <br>
                                职业医师资格证号：${doctor.certificateNo}
                                <br>
                                <input type="button" value="预约这个医生" />
                            </td>
                    </c:forEach>
                </table>
            </div>
